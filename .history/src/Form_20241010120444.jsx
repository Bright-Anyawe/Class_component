...
console.log(index)
  ...
  function handleItemDisplay() {
     const deleteBtn = document.querySelector(".deleteBtn");
     const sibling = deleteBtn.previousElementSibling;
     console.log(sibling);
  }

  function handleEdit(e, index) {

    // const listItem = getAttribute(data-list, "list");
    ...
    // console.log(parent)
    // const displayNone = parent.style.display = 'none';
        ...
        <ul>
          {toDoList.toDos.map((todo, index) => (
            <div className="itemContainer" data-index={index} key={todo}>
              ...
              <li className='todoListEl' data-list='list' > {todo}</li>
              <button
                className="deleteBtn"
