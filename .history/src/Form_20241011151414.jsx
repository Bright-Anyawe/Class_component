...
console.log(index)
 ...
 const deleteBtn = document.querySelector(".deleteBtn");
 const toDoList = deleteBtn.previousElementSibling;
 const toDoListDataSet = toDoList.dataset.list;
 console.log(toDoListDataSet);
    //  data - list;
// const editBtn = e.target
// const sibling = editBtn.previousElementSibling
// console.log(sibling)
// console.log(index)
// console.log(todo)
    // handleItemDisplay(e);
        ...
        <ul>
          {toDoList.toDos.map((todo, index) => (
            <div className="itemContainer" data-index={index} key={todo}>
              ...
              <button className="editBtn" onClick={(e) => handleEdit(e, index, todo)}>
                {editText}
              </button>
            </div>
          ))}
