...
export default function Form({ increaseToDos, decreaseToDos, onTodoCount }) {
  ...
  // }
   ...
   function handleInputEditDisplay(e) {
      ...
      console.log(taskInputtaskInput.addEventListener('change', () => console.log(taskInput.value))
console.log(taskInput)alue);
...
taskInput.addEventListener('change', () => console.log(taskInput.value))
console.log(taskInput)
